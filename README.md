...
# Data Structure 
Swiggy data structure as seen below consists of five tables: Users, Restaurant, Menu, Food and Orders with total rows count more than 1,00,000 records.

  <img width="800" height="500" alt="Screenshot 2025-11-22 102329" src="https://github.com/user-attachments/assets/371190c9-bf65-465c-be46-031a8e76d4d7" />

# Executive Summary

### Overview Findings

The platform sees high order volume from Students, who heavily outpace all other occupations. While Veg items  are most frequently increasing  (122M) than Non Veg , Non Veg commands a much higher average price ($274.76). Geographically, Tirupati is the top city by far in both sales and restaurant count. Overall, the data shows strong concentration in both customer segment and city performance.

Below is the overview page from PowerBI dashboard and more examples includes in report. The entire interactive dashboard can see <a href="https://app.powerbi.com/view?r=eyJrIjoiOTQ2MGU2ZjMtNjFlNy00OWY4LThlODYtYTUzYjQ1ZDY2MDhjIiwidCI6IjU1OTE4Y2FlLWQ4MGItNGRjMS04OWJjLWUyYWMyY2I3YTY3ZSJ9 " target="_blank">Here</a>

<img width="1130" height="653" alt="Screenshot 2025-11-18 183606" src="https://github.com/user-attachments/assets/52be3e94-75aa-42aa-910a-2660756912a3" />
